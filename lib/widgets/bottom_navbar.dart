      ...
      child: Container(
        ...
        child: NavigationBar(
          destinations: [
            ...
            _buildNavItem(icon: Icons.account_balance_wallet_rounded, index: 1, label: 'Earnings', colorScheme: colorScheme),
            _buildNavItem(icon: Icons.directions_car_filled_rounded, index: 2, label: 'Rides', colorScheme: colorScheme),
